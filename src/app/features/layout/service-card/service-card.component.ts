  ...
  listContent = [
    {
      ...
      title2: 'Thành lập',
      content:
        '2KT cung cấp dịch vụ thành lập doanh nghiệp uy tín, với đội ngũ giàu kinh nghiệm, hỗ trợ mọi thủ tục pháp lý cho các loại hình doanh nghiệp như Công ty TNHH, Công ty Cổ phần, Công ty vốn nước ngoài, Chi nhánh và Hộ kinh doanh cá thể. Cam kết chi phí hợp lý, minh bạch, giúp khách hàng an tâm khởi nghiệp và phát triển.',
      index: '01',
    },
    {
      id: 'ke-toan',
    ...
    },
    {
      ...
      title2: '',
      content:
        '2KT cung cấp các dịch vụ khác hỗ trợ toàn diện cho doanh nghiệp, bao gồm hóa đơn điện tử, bảo hiểm xã hội, tạm ngừng kinh doanh, giải thể doanh nghiệp, đăng ký kinh doanh, chữ ký số, đăng ký mã số thuế cá nhân và soạn thảo hợp đồng. Với uy tín và chi phí hợp lý, 2KT cam kết giúp doanh nghiệp dễ dàng xử lý các thủ tục pháp lý, tập trung vào phát triển kinh doanh.',
      index: '04',
    },
  ];
