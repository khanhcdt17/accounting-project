  ...
  items = [
    {
      ...
      comment: `Công ty đại lý Thuế 2KT cung cấp các dịch vụ thuế chất lượng cao, giá cả hợp lý và 
    ...
    },
    {
      ...
      comment: `Dịch vụ chuyên nghiệp và chất lượng. Đội ngũ tư vấn nhiệt tình, hiểu rõ về nhu cầu của khách hàng. 
        Chúng tôi đã có những trải nghiệm cực kỳ hài lòng với dịch vụ của công ty đại lý Thuế 2KT.`,
    },
    {
      image: 'https://i.imgur.com/TA72NnW.jpg',
      name: 'Nguyễn Hoàng Thông',
      position: 'Founder công ty GreenDay',
      comment: `Công ty đại lý Thuế 2KT cung cấp dịch vụ chất lượng và đẳng cấp. Chúng tôi đã tìm thấy sự chuyên nghiệp và 
    ...
    },
    {
      ...
      comment: `Tôi đã hợp tác với công ty đại lý Thuế 2KT trong nhiều dự án và luôn ấn tượng bởi sự chuyên nghiệp và tận tâm của họ. 
    ...
    },
    {
      ...
      comment: `Công ty đại lý Thuế 2KT mang lại giá trị chất lượng và sự uy tín. Đội ngũ nhân viên có khả năng hiểu rõ về nhu cầu và 
